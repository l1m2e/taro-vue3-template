...
<template>
	<live-player model="RTC" :enable-auto-rotation="true" class="w-100vw h-250px relative" :src="liveStreamingAddress" :autoplay="true" id="live-player" @onFullScreenChange="fn">
		<div class="w-100% h-30px box-border bg-#0000003b  absolute bottom-0 flex items-center justify-end px-10px color-white text-white">
